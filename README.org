...
#+END_SRC
*** Timing active tasks
Specialized functions for starting and stopping time when change to and from ACTIVE and PAUSED. Clock is automatically stopped on closing tags (DONE, CANCEL, etc.).
...
(use-package projectile
  ...
  (when (file-directory-p "~/work")
    (setq projectile-project-search-path '("~/work" "~/work/hubstaff/src" "~/work/amec")))
