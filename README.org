...
#+END_SRC
** Ruby
First, connect most ruby files with ~ruby-mode~.
...
#+END_SRC
*** REPL
Common library for opening REPL inside Emacs is [[https://github.com/nonsequitur/inf-ruby/][inf-ruby]].
...
Use [[https://github.com/dgutov/robe][Robe]] with ~ruby-mode~ to attach to ~inf-ruby~ subprocess and show some info about the methods.
...
(use-package writegood-mode
  :ensure t
  :init (global-set-key (kbd "C-c q") 'writegood-mode))
#+END_SRC
** Touch typing
