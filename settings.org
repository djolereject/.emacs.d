...
**** fly-spell
[[https://github.com/d12frosted/flyspell-correct][flyspell-correct]] is version of embedded `fly-spell` package for catching spelling mistakes, but with added interface. This interface can easily be made to work with `ivy` which is convenient in this setup, other way would be to use popup.
...
#+END_SRC
**** writegood-mode
[[https://github.com/bnbeckwith/writegood-mode][writegood-mode]] is useful for checking for weasel words, passive voice or duplicates in prose.
...
#+END_SRC
*** Paste
When typing over selected text, I want it to be replaced and not appended. One of the rare cases when all other editors got it right before Emacs.
